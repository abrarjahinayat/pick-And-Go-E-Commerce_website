...
const PoloSection = () => {
  ...
  useEffect(() => {
    // Fetch banner
    axios
      .get(`${process.env.NEXT_PUBLIC_API}/productCollectionBanner/getdesignerpolobanner`, { cache: 'no-store' })
      .then((res) => {
    ...
    // Fetch polo products
    axios
      .get(`${process.env.NEXT_PUBLIC_API}/products/categorypolo/polo`, { cache: 'no-store' })
      .then((res) => {
