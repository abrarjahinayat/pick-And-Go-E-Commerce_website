...
const PremiumSocksSection = () => {
  ...
  useEffect(() => {
    // Fetch banner
    axios
      .get(`${process.env.NEXT_PUBLIC_API}/productCollectionBanner/getpremiumsockesbanner`, { cache: 'no-store' })
      .then((res) => {
    ...
    axios
      .get(`${process.env.NEXT_PUBLIC_API}/products/categorypremiumsockes/socks`, { cache: 'no-store' })
      .then((res) => {
...
export default PremiumSocksSection