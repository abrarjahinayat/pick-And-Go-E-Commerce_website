...
const WomenProductSection = () => {
  ...
  useEffect(() => {
    // Fetch banner
    axios
      .get(`${process.env.NEXT_PUBLIC_API}/productCollectionBanner/getwomenproductsbanner`, { cache: 'no-store' })
      .then((res) => {
    ...
    axios
      .get(`${process.env.NEXT_PUBLIC_API}/products/category/women-t-shirt`, { cache: 'no-store' })
      .then((res) => {
